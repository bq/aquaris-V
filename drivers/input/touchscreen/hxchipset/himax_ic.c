...
void himax_pin_reset(void)
{
		...
		msleep(20);
		gpio_direction_input(private_ts->rst_gpio);
...
static uint8_t Self_Test_Bank(uint8_t *RB1H)
{
	...
	//=============================== Get Bank value End===============================
		...
		if (1)
		{
			...
			set_bnk_ulmt = 130;
			set_bnk_dlmt = 40;
			set_avg_bnk_ulmt = 200;
			set_avg_bnk_dlmt = 50;
			set_slf_bnk_ulmt = 220;
			set_slf_bnk_dlmt = 30;
	...
	if(IC_TYPE == HX_85XX_ES_SERIES_PWON)
		{
			...
			//for not reading info correctly
			ic_data->HX_RX_NUM				= 14;
			ic_data->HX_TX_NUM				= 25;
			ic_data->HX_BT_NUM				= 3;
			ic_data->HX_X_RES				= 1280;
			ic_data->HX_Y_RES				= 720;
			ic_data->HX_MAX_PT				= 10;
			ic_data->HX_XY_REVERSE			= true;
			ic_data->HX_INT_IS_EDGE			= true;
			ic_data->HX_RX_NUM_2 			= 14;				 
			ic_data->HX_TX_NUM_2 			= 25;
			Is_2T2R 						= true; 
