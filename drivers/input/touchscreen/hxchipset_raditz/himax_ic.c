...
static uint8_t Self_Test_Bank(uint8_t *RB1H)
{
	...
	//=============================== Get Bank value End===============================
		...
		if (1)
		{
			...
			set_bnk_ulmt = 211; 
			set_bnk_dlmt = 76; 
			set_avg_bnk_ulmt = 172; 
			set_avg_bnk_dlmt = 91; 
			set_slf_bnk_ulmt = 203; 
			set_slf_bnk_dlmt = 39; 
	...
	if(IC_TYPE == HX_85XX_ES_SERIES_PWON)
		{
	        ...
	        ic_data->HX_RX_NUM                       = 15; 
	        ic_data->HX_TX_NUM                       = 27; 
	        ic_data->HX_BT_NUM                       = 3; 
	        ic_data->HX_X_RES                        = 1920; 
	        ic_data->HX_Y_RES                        = 1080; 
	        ic_data->HX_MAX_PT                       = 10; 
	        ic_data->HX_XY_REVERSE                   = true; 
	        ic_data->HX_INT_IS_EDGE                  = true; 
	        ic_data->HX_RX_NUM_2                     = 15;                         
	        ic_data->HX_TX_NUM_2                     = 27;         
	        Is_2T2R                                  = true; 
		}
		else
		{
